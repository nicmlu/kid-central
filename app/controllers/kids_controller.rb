class KidsController < ApplicationController
    ...
    post '/kids' do #creates new kid object and assigns params, saves to db, redirect to kid profile 
        @kid = Kid.create(:name => params[:name], :nickname => params[:nickname], :gender => params[:gender], :birthdate => params[:birthdate])
